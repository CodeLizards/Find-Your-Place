...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_app2.default, { google: window.google }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MapContainer = __webpack_require__(53);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'placesStatus',
	    value: function placesStatus(bool) {
	      this.setState({ searchingPlace: false });
	    }
	  }, {
	    key: 'searchPlaces',
	    value: function searchPlaces(event, input) {
	    ...
	    key: 'displayPlaces',
	    value: function displayPlaces(places) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          null,
	          _react2.default.createElement('input', { ref: 'newPlace', className: 'input-field' }),
	          _react2.default.createElement(
	            'button',
	            {
	...
	SearchBox.propTypes = {
	  searchPlaces: _react.PropTypes.function
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapContainer = function (_Component) {
	  ...
	  _createClass(MapContainer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'container col-md-12', style: style },
	...
	MapContainer.propTypes = {
	  ...
	  query: _react.PropTypes.isRequired,
	  displayPlaces: _react.PropTypes.function,
	  placesStatus: _react.PropTypes.function
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchBox = __webpack_require__(39);
	...
	var Map = function (_Component) {
	  ...
	  _createClass(Map, [{
	    ...
	    value: function getUserLocation() {
	      ...
	      if (navigator.geolocation) {
	        navigator.geolocation.getCurrentPosition(function (position) {
	          ...
	          _this2.setState({ lat: position.coords.latitude }, function () {
	            _this2.setState({ lng: position.coords.longitude }, function () {
	              _this2.loadMap();
	            });
	          });
	        }, function () {
	    ...
	    value: function showInfoWindow(place, marker) {
	      ...
	      var content = '<h2 id="firstHeading" class="firstHeading">' + place.name + '</h2>\n      <div id="bodyContent">\n        <div>Rating: ' + (place.rating || 'No Ratings') + '</div>\n        <div>' + place.formatted_address + '</div>\n      </div>';
	    ...
	    value: function createMarker(place) {
	      ...
	      this.props.google.maps.event.addListener(marker, 'click', function () {
	        return _this3.showInfoWindow(place, marker);
	      });
	    ...
	    key: 'findPlaces',
	    value: function findPlaces() {
	      var _this4 = this;

	      var center = new this.props.google.maps.LatLng(this.state.lat, this.state.lng);
	      var request = {
	        location: center,
	        radius: '10',
	      ...
	      service.textSearch(request, function (results, status) {
	        if (status === _this4.props.google.maps.places.PlacesServiceStatus.OK) {
	          // remove markers from old result before placing new ones to avoid reloading map;
	          _this4.removeMarkers();
	          // create markers
	          for (var i = 0; i < results.length; i++) {
	            _this4.props.displayPlaces(results);
	            var place = results[i];
	            _this4.createMarker(place);
	          }
	          // let other components know that places have been loaded
	        } else {
	            var errorMessage = 'We could not find any places matching your search! My bad. Perhaps try something more general. Like sushi...mmm sushi.';
	            alert(errorMessage);
	          }
	        _this4.props.placesStatus(true);
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { ref: 'map', id: 'map', className: 'col-md-12' },
